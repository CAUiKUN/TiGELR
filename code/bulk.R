# nohup Rscript multi_models.R > multi_models.log 2>&1 &
rm(list = ls())
...
for (seed in seeds) {
  ...
  # 别名替换
  genes <- gsub("ADGRE5", "CD97", genes)
  genes <- gsub("ADGRG1", "GPR56", genes)
...
# seed <- 2
# 
# final_results <- read_csv(paste0("/work/DongZ/project/CosMx/CRC/figures_final/figure5/ROC_bulk/result/cv_metrics_detail_", seed, ".csv"))
# summary_stats <- read_csv(paste0("/work/DongZ/project/CosMx/CRC/figures_final/figure5/ROC_bulk/result/cv_metrics_summary_", seed, ".csv"))
# sample_pred_all <- read_csv(paste0("/work/DongZ/project/CosMx/CRC/figures_final/figure5/ROC_bulk/result/sample_predictions_all_folds_", seed, ".csv"))
# 
# # 计算每个模型的合并ROC曲线
# model_names <- unique(sample_pred_all$Model)
# roc_combined <- list()
...
# )
# 
# pdf("/work/DongZ/project/CosMx/CRC/figures_final/figure5/ROC_bulk.pdf",
#     width = 5, height = 5)
# plot.roc(roc_combined$glm, 
#          col = my_palette["glm"], 
#          ylim = c(0, 1), 
...
#   )
# ggsave("/work/DongZ/project/CosMx/CRC/figures_final/figure5/Metric_bulk.pdf",width = 6, height = 4)
# 


# 
# 
# seeds <- seq(60, 1000, by = 10)
# for (seed in seeds) {
#   set.seed(seed)
#   
#   # 数据划分
...
#     pdf(paste0("/work/DongZ/project/CosMx/CRC/figures_final/figure5/ROC_bulk/ROC_", seed, ".pdf"), width = 4, height = 4)
